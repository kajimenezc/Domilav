...
<html>
    ...
    <body>
        <h1 class="header-w3ls">
            <!--      <a href="index.jsp" style="color: white;"><img src="login/9.png" alt=""/>-->
        </h1>
    ...
    <div class="mid-cls">
                 ...
                 <form action="#" method="post">
                     <div class="main">
                         <div class="icon-head-wthree">
                             ...
                             <img src="login/images/laundry-machine-variant-with-clothes-and-soap-on-top.png"/><BR>
                             <h4>Registrate</h4>
                         </div>
             ...
             <form action="#" method="post">
                 <div class="main">
                     ...
                     <div class="form-left-w3l">
                         ...
                         <input type="email" name="usu" placeholder="Usuario" required="">
        ...
        <div class="swm-left-w3ls" style="display: none;">
            ...
            <div class="icon-head-wthree">
                <h2><span class="fa fa-diamond t-w3" aria-hidden="true"></span></h2>
                <a href="index.jsp"><img src="login/images/laundry-machine-variant-with-clothes-and-soap-on-top.png"/><BR></a>
                <h4>Registrate</h4>
            </div>
        ...
        <div class="swm-right-w3ls">
            <div class="main">
                <form action="loginServlet" method="POST">
                    ...
                    <div class="icon-head-wthree">
                        <h2><span class="fa fa-diamond t-w3" aria-hidden="true"></span></h2>
                        <!--<img src="login/images/laundry-machine-variant-with-clothes-and-soap-on-top.png"/><BR><br>-->
                        <a href="index.jsp"><img src="login/altlogo_1.png"/><BR><br></a>
                        <h4>Iniciar Sesion</h4><br><br><br>
                    </div>
                    <div class="form-left-w3l">
                ...
                <div class="btnn">
                    ...
                    <form action="servletContra" method="POST">
                        ...
                        <center><input type="submit" class="for" name="contra" style="background: none; border: none; box-shadow: none; margin: 0px;" value="¿Olvidó su contraseña?">  </center>
                    </form>
                    <form action="servletCliente" method="POST">
                        <input type="hidden" name="opcion" value="1">
                        <center><input type="submit" class="for" name="registraa" style="background: none; border: none; box-shadow: none; margin: 0px;" value="¿Aún no tienes cuenta? Registrate."></center>                        
                    </form>
                </div>	
            </div>
        ...
        <!--    <form action="servletContra" method="POST">
                <input type="hidden" name="opcion" value="1">
                <center><input type="submit" class="for" name="contra" style="background: none; border: none; box-shadow: none; margin: 0px;" value="¿Olvidó su contraseña?">  
                    <a href="#" class="for" id="registrar">¿Aún no tienes cuenta?<br>Registrate.</a>  </center>
            </form>
        -->
    </div>	
